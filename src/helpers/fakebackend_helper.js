...
// verify user  call
export const verifyuserAPICALL = (reqbody) => api.create(url.JWT_LOGIN_URL, reqbody);
export const logoutuserAPICALL = (reqbody) => api.create(url.LOGOUT_URL, reqbody);

// categories-----
//get
export const getcategoryAPICALL = (reqbody) => api.create(url.VIEW_CONTACT_URL, reqbody);
//add
export const addcategoryAPICALL = (reqbody) => api.create(url.ADD_CONTACT_URL, reqbody);
//update
export const updatecategoryAPICALL = (reqbody) => api.create(url.UPDATE_CONTACT_URL, reqbody);

//delete
export const deletecontactAPICALL = (reqbody) => api.create(url.DELETE_CONTACT_URL, reqbody);
