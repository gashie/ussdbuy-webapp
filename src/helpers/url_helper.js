...
//auth
export const LOGIN_URL =`${version_one}/app/login`;
export const JWT_LOGIN_URL = `${version_one}/app/auth`;
export const LOGOUT_URL = `${version_one}/app/logout`;

//catgories

export const ADD_CONTACT_URL =`${version_one}/core/userServiceAPI/create`;
export const VIEW_CONTACT_URL = `${version_one}/core/userServiceAPI/view`;
export const UPDATE_CONTACT_URL = `${version_one}/core/userServiceAPI/update`;
export const DELETE_CONTACT_URL = `${version_one}/core/userServiceAPI/delete`;
