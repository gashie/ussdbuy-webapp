...
const Login = (props) => {
    ...
    const { userInfo, isloggedIn,loadingUserinfo,errorUserinfo,loading,error,errorMsg,loggedIn } = useSelector((state) => ({
    ...
    const validation = useFormik({
        ...
        initialValues: {
            email: userLogin.email || "rico@gmail.com" || '',
            password: userLogin.password || "CAL.12345" || '',
        },
